...
Command: npx gltfjsx@6.5.3 wizard-transformed.glb --transform 
Files: wizard-transformed.glb [3.56MB] > /Users/an/Documents/Projects/freeCodeCamp/portfolio-page-tutorial/public/models/wizard-transformed-transformed.glb [3.55MB] (0%)
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/wizard-transformed-transformed.glb')
  return (
...
useGLTF.preload('/wizard-transformed-transformed.glb')
